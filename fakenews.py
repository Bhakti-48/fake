...
st.title("📰 Fake News Detector - Advanced ML App Without Scikit-Learn")
...
col_a.markdown(f"""<div class='metric-box'><h4>✅ Model Accuracy</h4><h2>{round(accuracy * 100, 2)}%</h2></div>""", unsafe_allow_html=True)
